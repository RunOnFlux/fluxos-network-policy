...
//
// It is also the list of countries the artifact may name: a country with no
// entry here would ship without a continent, and every continent-scoped
// eligibility rule would silently stop seeing it. The overrides loader checks a
// corrected country against this same map, which is why the map lives on its own
